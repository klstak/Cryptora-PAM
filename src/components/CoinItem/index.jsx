...
const CoinItem = ({ marketCoin }) => {
  ...
  return (
    <Pressable style={styles.coinContainer} onPress={() => navigation.navigate("CoinDetailedScreen", { coinId: id })}>
      <Image source={{ uri: image }} style={{ height: 40, width: 40, marginRight: 10 }} />
      ...
      <View>
        ...
        <View style={{ flexDirection: "row" }}>
          ...
          <AntDesign name={price_change_percentage_24h < 0 ? "caretdown" : "caretup"} size={13} color={percentageColor} style={{ alignSelf: "center", marginRight: 3 }} />
